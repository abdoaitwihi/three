...
let moonTexture = new THREE.TextureLoader().load("/assets/images/threejs/moon_texture.jpg");

const moonMaterial = new THREE.MeshLambertMaterial({ map: moonTexture, overdraw: 0.1 });
...
const marsGeometry = new THREE.SphereGeometry(1, 50, 50);

let marsTexture = new THREE.TextureLoader().load("/assets/images/threejs/marsmap1k.jpg");

const marsMaterial = new THREE.MeshLambertMaterial({ map: marsTexture, overdraw: 0.1 });
...
document.addEventListener("scroll", (event) => {
  ...
  // camera.position.y = -window.scrollY / 150 + 0;
...
const tick = () => {
  ...
  moon.rotation.z = 0.125 * time;
  mars.rotation.z = 0.125 * time;
